...
public class SODAClient {
    ...
    //JMW: shifted from define to magic number - revisit...
    // .../SODAKit/SODAClient.swift:59:82: Let 'SODADefaultLimit' is internal and cannot be referenced from a default argument value
    
    public func get(dataset: String, withFilters: [String: String], limit: Int = 1000 /*SODADefaultLimit*/, offset: Int = 0, _ completionHandler: @escaping SODADatasetCompletionHandler) {
        var ps = withFilters
        ps["$limit"] = "\(limit)"
        ps["$offset"] = "\(offset)"
